(() => {
  ...
  // Inline SVG tree icon with realistic organic trunk, asymmetrical branches, and visible leaf buds
  ...
  treeSVG.innerHTML = '<defs><linearGradient id="ff-trunk-grad" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" style="stop-color:#5d7a55"/><stop offset="50%" style="stop-color:#6c9868"/><stop offset="100%" style="stop-color:#5d7a55"/></linearGradient></defs><g fill="none" stroke="url(#ff-trunk-grad)" stroke-width="2" stroke-linecap="round" stroke-dasharray="80" stroke-dashoffset="80"><path d="M14 25 C13.5 20 14 15 14 11 C14 8 13.5 5 14 3" class="ff-trunk"/><path d="M14 18 C11 16 8 14 6 11" class="ff-branch-left"/><path d="M14 15 C17 13 20 11 23 9" class="ff-branch-right"/><path d="M14 12 C12 10 10 9 8 7" class="ff-branch-sub-left"/><path d="M14 9 C16 8 18 6 20 5" class="ff-branch-sub-right"/></g><g class="ff-buds"><circle cx="6" cy="11" r="2" fill="#7fb375" opacity="0.9"/><circle cx="23" cy="9" r="1.8" fill="#7fb375" opacity="0.85"/><circle cx="8" cy="7" r="1.5" fill="#8fc485" opacity="0.8"/><circle cx="20" cy="5" r="1.3" fill="#8fc485" opacity="0.75"/><circle cx="14" cy="3" r="2.2" fill="#8fc485" opacity="0.95"/></g>';
